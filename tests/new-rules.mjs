...
s=setup('strike');s.enemy.hand=[{id:'saved',key:'medkit'}];s.enemy.confusion=9;use(s);s.enemy.deck=[{id:'e',key:'medkit'}];endTurn(s,()=>.5);assert.equal(s.enemy.hand.length,2);assert.equal(s.enemy.confusion,0);
