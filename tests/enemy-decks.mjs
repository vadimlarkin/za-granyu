...
const expected={
 ...
 cultist:['spark','ward'],
 gangster:['hit','guard','dodge','shot','haste','rob','maneuver','heal','dirty-bandages'],
 ...
 grandmaster:['hit','guard','dodge','shot','rob','maneuver','spark','ward','fireball','oblivion']
};
...
const expanded={...cards,extra:{...cards.hit,id:'extra',copies:0},gold:{...cards.hit,id:'gold',rarity:'gold'}};
...
assert.ok(!enemyDeck(cards,'Бродяга').includes('strike'));
