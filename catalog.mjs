...
export function describe(c){
 ...
 const special={none:'',rob:`Забрать до ${x} случайных карт из руки противника в свою руку.`,confuse:`Оглушение ${x}: в начале следующего хода противник сбрасывает до ${x} случайных карт из руки.`,cheap:'Скидка уже включена в стоимость.',draw:`Добрать ${x} карт.`,haste:`Снизить стоимость текущей руки на ${x}, минимум до 0.`,surprise:`Дополнительно ${x} урона оглушённому противнику.`,fortify:'При действующем уклонении получить оборонительную стойку: остаток физической защиты сохраняется до конца боя.',leftHook:`Непосредственно после «Правого коронного» в том же ходу: добавить ${x} урона к основному удару. В оплате «Правого коронного»: отдельный удар ${c.paymentAmount??c.specialAmount??4} без усиления.`,combo:`Если противник уже оглушён до розыгрыша, добрать ${x} карт.`,jab:`При оборонительной стойке нанести ${x} физического урона.`}[c.special??'none'];
