...
export const SPECIALS={none:'Нет',rob:'Грабёж',confuse:'Оглушение',cheap:'Пониженная стоимость',draw:'Добор',haste:'Снижение стоимости',surprise:'Неожиданный удар',fortify:'Укрепление'};
...
export function describe(c){
 ...
 const special={none:'',rob:`Забрать до ${x} случайных карт из руки противника в свою руку.`,confuse:`Оглушение ${x}: в начале следующего хода противник сбрасывает до ${x} случайных карт из руки.`,cheap:'Скидка уже включена в стоимость.',draw:`Добрать ${x} карт.`,haste:`Снизить стоимость текущей руки на ${x}, минимум до 0.`,surprise:`Дополнительно ${x} урона оглушённому противнику.`,fortify:'При действующем уклонении получить оборонительную стойку: остаток физической защиты сохраняется до конца боя.'}[c.special??'none'];
