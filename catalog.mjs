...
export function describe(c){
 ...
 const primary={none:'',shot:`Нанести ${n} физического урона: сначала магическая, затем физическая защита. Игнорирует уклонение.`,physical:`Нанести ${n} физического урона.`,magic:`Нанести ${n} магического урона.`,armor:`Получить ${n} физической защиты до следующего своего хода; со стойкой — до конца боя.`,ward:`Получить ${n} защиты от магии и выстрелов до следующего своего хода.`,heal:`Восстановить ${n} здоровья, не превышая максимум.`,haste:`Уменьшить стоимость всех остальных карт в руке на ${n}, минимум до 0.`,dodge:n===1?'Избежать следующей атаки, кроме выстрела. Остаток действует до конца следующего своего хода.':`Избежать следующих ${n} атак, кроме выстрелов. Остаток действует до конца следующего своего хода.`}[c.effect];
 const x=specialAmount(c);
 const special={none:'',rob:`Забрать до ${x} случайных карт из руки противника в свою руку.`,confuse:`Оглушение ${x}: в начале следующего хода противник сбрасывает до ${x} случайных карт из руки.`,cheap:'Скидка уже включена в стоимость.',draw:`Добрать ${x} карт.`,haste:`Снизить стоимость текущей руки на ${x}, минимум до 0.`,surprise:`При действующем уклонении у атакующего добавить ${x} урона к основному удару до защиты. Уклонение атакующего не расходуется.`,fortify:'При действующем уклонении получить оборонительную стойку: остаток физической защиты сохраняется до конца боя.',leftHook:`Непосредственно после «Правого коронного» в том же ходу: добавить ${x} урона к основному удару. В оплате «Правого коронного»: отдельный удар ${c.paymentAmount??c.specialAmount??4} без усиления.`,combo:`Если противник уже оглушён до розыгрыша, добрать ${x} карт.`,jab:`При оборонительной стойке нанести ${x} физического урона.`}[c.special??'none'];
 return [primary,special,c.bonus==='vigor'?`Бодрость духа ${c.bonusAmount}: добор в конце своего хода больше на ${c.bonusAmount}.`:c.bonus==='stance'?'Оборонительная стойка: сохранять физическую защиту до конца боя.':'',c.malus==='stun'?`Оглушение ${c.malusAmount}: в начале следующего хода противник сбрасывает до ${c.malusAmount} случайных карт из руки.`:''].filter(Boolean).join(' ');
}
